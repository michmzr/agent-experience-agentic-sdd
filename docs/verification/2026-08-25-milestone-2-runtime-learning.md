...
| Focused schema, compiler, promotion, CLI, acceptance, and benchmark run | Passed at the implementation commit: 60 passed, 0 failed, 0 skipped. |
| `pnpm check` | Passed at the implementation commit: TypeScript build succeeded; 376 tests passed, 0 failed, 0 skipped. |
