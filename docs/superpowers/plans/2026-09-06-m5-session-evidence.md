...
- [ ] **Step 1: Write failing correlation and lifecycle tests**
...
- [ ] **Step 3: Implement the minimal public contract and reconstructor**
...
- [ ] **Step 1: Write failing outcome, waiting, usage and privacy tests**
...
- [ ] **Step 3: Implement bounded deterministic measurements**
...
- [ ] **Step 3: Implement the versioned repository**
...
- [ ] **Step 1: Write failing projection and CLI acceptance tests**
...
- [ ] **Step 3: Implement projection and read-only CLI reporting**
...
- [ ] **Step 5: Record measured evidence only after verification**
